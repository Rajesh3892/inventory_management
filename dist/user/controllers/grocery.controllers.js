...
exports.myOrders = exports.getAllItems = void 0;
const db_config_1 = __importDefault(require("../../db.config"));
const getAllItems = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const items = yield db_config_1.default.query('SELECT * from grocery WHERE stock > 0');
...
const myOrders = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
